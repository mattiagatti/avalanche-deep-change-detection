...
# Bandara, W. G. C., & Patel, V. M. 
# "ChangeFormer: A Transformer-Based Siamese Network for Change Detection." 
# In IEEE International Geoscience and Remote Sensing Symposium (IGARSS), 2022, pp. 207–210. IEEE.
...
class ChangeFormerV4(nn.Module):
    ...
    def __init__(self, input_nc=3, output_nc=2, decoder_softmax=False,
        ...
        self.Tenc_x2    = EncoderTransformer_x2(img_size=img_size, patch_size=patch_size, in_chans=input_nc, num_classes=output_nc, embed_dims=self.embed_dims,
...
class DecoderTransformer_v3(nn.Module):
    ...
    def forward(self, inputs1, inputs2):
        ...
        + F.interpolate(_c4, size=_c3_1.shape[-2:], mode="bilinear", align_corners=False)
        ...
        + F.interpolate(_c3, size=_c2_1.shape[-2:], mode="bilinear", align_corners=False)
        ...
        + F.interpolate(_c2, size=_c1_1.shape[-2:], mode="bilinear", align_corners=False)
...
class ChangeFormerV5(nn.Module):
    ...
    def __init__(self, input_nc=3, output_nc=2, decoder_softmax=False, embed_dim=256,
        ...
        self.Tenc_x2    = EncoderTransformer_v3(img_size=img_size, patch_size=patch_size, in_chans=input_nc, num_classes=output_nc, embed_dims=self.embed_dims,
